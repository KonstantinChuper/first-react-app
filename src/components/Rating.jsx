...
export default function Rating() {
  ...
  return (
    <div className="ratingBox">
      <h1 className="ratingHeader">Choose your rating</h1>
      <img className="ratingImg" src={ratingList[rating]} alt="rating" />
      <div className="ratingButtonsLine">
        <button className="ratingButton" onClick={() => setRating(0)}>Bad</button>
        <button className="ratingButton" onClick={() => setRating(1)}>Acceptable</button>
        <button className="ratingButton" onClick={() => setRating(2)}>Good</button>
        <button className="ratingButton" onClick={() => setRating(3)}>Excellent</button>
      </div>
    </div>
  );
}
